...
{
    public function buildForm(FormBuilderInterface $builder, array $options): void  /* Définition des divers types de champs pour le formulaire d'ajout de panne et des paramètres qui leur sont assignés si besoin */
    {
        $builder
        ->add('machine')
        ->add('criticite')
